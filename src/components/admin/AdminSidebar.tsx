...
export function AdminSidebar() {
    ...
    return (
        <aside className="hidden lg:flex flex-col w-72 h-full bg-admin-sidebar border-r border-admin-sidebar-border shrink-0 transition-all duration-300">
            {/* Logo & Header */}
            ...
            {/* User Footer */}
            <div className="p-4 border-t border-admin-sidebar-border space-y-3">
